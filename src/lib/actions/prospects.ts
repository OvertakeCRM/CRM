...
export async function createProspect(
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      price_per_container: formData.get("price_per_container") ? Number(formData.get("price_per_container")) : null,
      dm_name: String(formData.get("dm_name") ?? "") || null,
      dm_phone_cell: String(formData.get("dm_phone_cell") ?? "") || null,
      dm_phone_work: String(formData.get("dm_phone_work") ?? "") || null,
